...
import themedbingo.composeapp.generated.resources.update_nickname_advice
...
fun UpdateNameDialog(
    ...
    val updatedNickname = mutableStateOf(currentName)
    ...
    Dialog(
        ...
        Card(
            ...
            Column(
                ...
                Text(
                    text = stringResource(Res.string.update_nickname_title),
                ...
                Text(
                    text = stringResource(Res.string.update_nickname_body),
                    modifier = Modifier.fillMaxWidth()
                )
                ...
                OutlinedTextField(
                    value = updatedNickname.value,
                    onValueChange = { input ->
                        updatedNickname.value = input.trim()
                    },
                ...
                Text(
                    text = stringResource(Res.string.update_nickname_advice),
                ...
                Row(
                    ...
                    TextButton(
                        onClick = { onConfirm(updatedNickname.value) },
                        enabled = (updatedNickname.value.length > 4)
                    ) {
